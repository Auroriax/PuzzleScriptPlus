...
var codeMirrorFn = function() {
    ...
    var reg_directions = /^(action|up|down|left|right|\^|v|\<|\>|moving|stationary|parallel|perpendicular|horizontal|orthogonal|vertical|no|randomdir|random|anim_left|anim_right|anim_up|anim_down|anim_towards|anim_cw|anim_away|anim_ccw)$/;
